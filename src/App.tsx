      ...
      <div className="h-32 flex items-end space-x-4">
        {compactInData.map((inValue, index) => {
          ...
          return (
            ...
            >
              {hoveredIndex === index && (
                <div className="absolute -top-12 bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap z-10">
                  In: {inValue} | Resolved: {resolvedValue}
                </div>
              )}
              <div className="w-full flex space-x-2">
                <div
                  className="flex-1 bg-[#4FBDBA] rounded-t transition-all duration-300 hover:bg-[#4FBDBA]/80"
                  style={{ height: `${(inValue / maxValue) * 80}px` }}
                />
                <div
                  className="flex-1 bg-[#F3C969] rounded-t transition-all duration-300 hover:bg-[#F3C969]/80"
                  style={{ height: `${(resolvedValue / maxValue) * 80}px` }}
                />
              </div>
  ...
  return (
    <div className="bg-[#232424] rounded-xl p-6 shadow-lg">
      ...
      <div className="relative h-32">
        ...
        {hoveredIndex !== null && (
          <div 
            className="absolute bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap pointer-events-none z-10"
            style={{
          ...
          >
            {weeks[hoveredIndex]}: {data[hoveredIndex]}{unit}
          </div>
        )}
      </div>
                ...
                {data[weekIndex].map((percentage, catIndex) => (
                  ...
                  >
                    {hoveredWeek === weekIndex && (
                      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap z-10">
                        {categories[catIndex]}: {percentage}%
                      </div>
                    )}
                  </div>
                ))}
...
function App() {
  ...
  const kpiData = [
    {
      ...
      sparklineData: [980, 1120, 1050, 1180, 1247],
    },
    {
      ...
      sparklineData: [950, 1080, 1020, 1150, 1189],
    },
    {
      title: 'FRT Median',
      value: '2.4h',
      ...
      sparklineData: [3.2, 2.8, 3.1, 2.7, 2.4],
    },
    {
      ...
      trend: 'up' as const,
      icon: <Clock className="w-5 h-5" />,
      sparklineData: [22.1, 20.8, 21.3, 19.2, 18.5],
    },
    {
      title: 'FCR %',
      value: '78.2%',
      ...
      sparklineData: [72.5, 75.1, 74.8, 76.9, 78.2],
    },
  ];
  ...
  const ticketsInData = [980, 1120, 1050, 1180, 1247];
  const ticketsResolvedData = [950, 1080, 1020, 1150, 1189];
  const frtData = [3.2, 2.8, 3.1, 2.7, 2.4];
  const ahtData = [22.1, 20.8, 21.3, 19.2, 18.5];
  const fcrData = [72.5, 75.1, 74.8, 76.9, 78.2];
            ...
            {isCompact ? (
              ...
              <div className="space-y-4">
                ...
                <CompactChart 
                  ...
                  inData={ticketsInData}
                  resolvedData={ticketsResolvedData}
                />
              </div>
            ) : (
                  ...
                  <div className="lg:col-span-2">
                    <div className="bg-[#232424] rounded-xl p-6 shadow-lg">
                      ...
                      <div className="relative h-40">
                        ...
                        {ticketsInData.map((inValue, index) => {
                          const resolvedValue = ticketsResolvedData[index];
                          const maxValue = Math.max(...ticketsInData, ...ticketsResolvedData);
                          const isCurrentWeek = index === ticketsInData.length - 1;
